...
surface.CreateFont( "JHUDMain", { size = 20, weight = 4000, font = "FiBuchetMS-Bold" } )
surface.CreateFont( "JHUDMainBIG", { size = 48, weight = 4000, font = "FiBuchetMS-Bold" } )
surface.CreateFont( "JHUDMainBIG2", { size = 28, weight = 4000, font = "FiBuchetMS-Bold" } )
