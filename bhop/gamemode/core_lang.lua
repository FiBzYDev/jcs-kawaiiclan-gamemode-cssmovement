...
Lang.BotSaving = "Replays will now be saved, a short period of lag may occur."
...
Lang.VotePlayer = "1; wants a map change (2; 3; required)"
Lang.VoteStart = "A vote to change map has started, choose your maps!"
Lang.VoteExtend = "The vote has decided that the map is to be extended by 1; minutes!"
Lang.VoteChange = "Changing map to 1; in 10 seconds."
...
Lang.MapInavailable = "This map does not exist, not added or not zoned. Please contact an administrator if you feel this is incorrect."
...
Lang.MiscAbout = "This gamemode, " .. GM.Name .. " version " .. tostring( _C.Version ) .. ", was developed by " .. GM.Author .. "."
