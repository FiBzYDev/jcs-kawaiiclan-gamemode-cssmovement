...
local CCrosshair = CreateClientConVar( "kawaii_crosshair", "1", true, false )
local CGap = CreateClientConVar( "kawaii_cross_gap", "1", true, false )
local CThick = CreateClientConVar( "kawaii_cross_thick", "0", true, false )
local CLength = CreateClientConVar( "kawaii_cross_length", "1", true, false )
local CColorR = CreateClientConVar( "kawaii_cross_color_r", "0", true, false )
local CColorG = CreateClientConVar( "kawaii_cross_color_g", "160", true, false )
local CColorB = CreateClientConVar( "kawaiicross_color_b", "180", true, false )
local CColorA = CreateClientConVar( "kawaii_cross_opacity", "255", true, false )
